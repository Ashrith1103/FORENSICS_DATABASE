...
-- CriminalBackup
CREATE TABLE `criminalbackup` (`ID` varchar(255) DEFAULT NULL,`CriminalName` varchar(255) DEFAULT NULL,`Alias` varchar(255) DEFAULT NULL,`NoOfCases` int(11) DEFAULT NULL,`dominantHand` varchar(255) DEFAULT NULL,  `Nationality` varchar(255) DEFAULT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
-- User Credentials
CREATE TABLE `user_credentials` (  `Username` VARCHAR(255) NOT NULL UNIQUE,  `Password` VARCHAR(255) NOT NULL,  `Role` VARCHAR(50) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
